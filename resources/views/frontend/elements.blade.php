			...
			<div class="whole-wrap">
				<div class="container">
					<div class="section-top-border">
						...
						<div class="row">
							<div class="col-md-3">
								<img src="{{url ('frontend/image/elements/d.jpg')}}" alt="" class="img-fluid">
							</div>
						...
						<div class="progress-table-wrap">
							<div class="progress-table">
								...
								<div class="table-row">
									...
									<div class="country"> <img src="{{url ('frontend/image/elements/f1.jpg')}}" alt="flag">Canada</div>
								...
								<div class="table-row">
									...
									<div class="country"> <img src="{{url ('frontend/image/elements/f2.jpg')}}" alt="flag">Canada</div>
									<div class="visit">645032</div>
									<div class="percentage">
										<div class="progress">
								...
								<div class="table-row">
									...
									<div class="country"> <img src="{{url ('frontend/image/elements/f3.jpg')}}" alt="flag">Canada</div>
									<div class="visit">645032</div>
									<div class="percentage">
										<div class="progress">
